...
public class Get06 extends RestfulBaseUrl {
    ...
    "additionalneeds": "Breakfast"
        ...
        // 2. Yol : Jsonpath class'nın kullanimiBreakfast
        ...
        softAssert.assertEquals(json.getString("firstname"), "Howard", "First Name Hatali");
        softAssert.assertEquals(json.getString("lastname"), "Combs", "Last Name Hatali");
